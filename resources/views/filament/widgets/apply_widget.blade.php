                ...
                <div class="grid grid-cols-3">
                    <a href="{{ url('/jobs/1') }}">
                        <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl hover:scale-105 transition-all border">
                            <img src="{{ asset('images/Research-Analyst.webp') }}" alt="Apply Now" class="rounded-2xl"/>
{{--                            <h2 class="text-center pt-2 pb-4 color-primary">{{__('Research Analyst')}}</h2>--}}
                            <h3 class="font-bold text-2xl text-center py-6 color-primary">{{__('Research Analyst')}}</h3>
                            <button
