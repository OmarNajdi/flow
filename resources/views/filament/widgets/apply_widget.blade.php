        ...
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                ...
                <div class="grid grid-cols-3 gap-10">
                    <a href="{{ url('/programs/4') }}">
                        <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl hover:scale-105 transition-all border">
                            <img src="{{ asset('images/PIEC-incubation.webp') }}" alt="Apply Now" class="rounded-2xl"/>
                            <h2 class="text-center pt-2 pb-4 color-primary">{{__('Level: Incubation')}}</h2>
                    ...
                    <a href="{{ url('/programs/5') }}">
                        <div class="bg-gray-100 dark:bg-gray-800 rounded-2xl hover:scale-105 transition-all border">
                            <img src="{{ asset('images/OC.webp') }}" alt="Apply Now" class="rounded-2xl"/>
